    ...
    <center>
        ...
        <table border="2" style="text-align: center;">
            ...
            <tr>                
                ...
                <td align="center"><a href="http://localhost:8081/Ficharpg/controller_personagem?op=CONSULTAR%20BY%20ID&ident=<%out.print(per.getId());%>"><img src="./imagem/plus.png""></a></td>
                <td align="center"><a href="http://localhost:8081/Ficharpg/controller_personagem?op=ATUALIZAR&ident=<%out.print(per.getId());%>&nome<%out.print(per.getNome());%>&conceito<%out.print(per.getConceito());%>&caracteristicas<%out.print(per.getCaracteristicas());%>&historico<%out.print(per.getHistorico());%>&equipamento<%out.print(per.getEquipamento());%>&defeito<%out.print(per.getDefeito());%>&ptheroi<%out.print(per.getPtheroi());%>&nvsaude<%out.print(per.getNvsaude());%>&proeza1<%out.print(per.getProeza1());%>&proeza2<%out.print(per.getProeza2());%>&proeza3<%out.print(per.getProeza3());%>&ptproeza1<%out.print(per.getPtproeza1());%>&ptproeza2<%out.print(per.getPtproeza2());%>&ptproeza3<%out.print(per.getPtproeza3());%>" ><img src="./imagem/edit.png"></a></td>
                <td align="center"><a href="http://localhost:8081/Ficharpg/controller_personagem?op=DELETAR&ident=<%out.print(per.getId());%>"><img src="./imagem/delete.png""></a></td>
            </tr>
            <%}%>
